...
module.exports = {
  ...
  output: {
    path: path.resolve(__dirname, ''),// Specify the base path for all the styles within your
    ...
    // to the output path, so './js'
    filename: 'web/js/sass.js',
  },
  module: {
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: devMode ? 'web/css/site.css' : 'web/css/site.min.css',
    }),
  ],
};
